            ...
            <motion.div initial="out" animate="in" exit="out" variants={animationOne} transition={transition}>
                ...
                <div className="contact-us-container">
                    <h1 className="big-text">Freelance Work or Hire me for Employment</h1>
                                ...
                                <motion.div  whileHover={{ scale: 1.1 }}  whileTap={{ scale: 0.80 }} >
                    ...
                    <div className="social-media">
                                <motion.div  whileHover={{ scale: 1.1 }}  whileTap={{ scale: 0.80 }} >
                                        <a href="https://www.facebook.com/xenofy/">
                                            <img src="images/facebook.png" alt="" height="80" width="80"/>
                                        </a>
                                </motion.div>
                                <motion.div  whileHover={{ scale: 1.1 }}  whileTap={{ scale: 0.80 }} >
                                <a href="https://github.com/xenodochy23">
                                <img src="images/github (2).png" alt="" height="80" width="80"/>
                                </a>
                                </motion.div>                            
                                <motion.div  whileHover={{ scale: 1.1 }}  whileTap={{ scale: 0.80 }} >
                                        <a href="https://www.instagram.com/iamachipmunks/">
                                            <img src="images/instagram.png" alt="" height="80" width="80"/>
                                        </a>
                                </motion.div>
                                <motion.div  whileHover={{ scale: 1.1 }}  whileTap={{ scale: 0.80 }} >
                                    <a href="https://www.twitter.com">
                                            <img src="images/twitter (1).png" alt="" height="80" width="80"/>
                                    </a>
                                </motion.div>
                                <motion.div  whileHover={{ scale: 1.1 }}  whileTap={{ scale: 0.80 }} >
                                    <a href="https://www.twitter.com">
                                            <img src="images/linkedin (2).png" alt="" height="80" width="80"/>
                                    </a>
                                </motion.div>
                                <motion.div  whileHover={{ scale: 1.1 }}  whileTap={{ scale: 0.80 }} >
                                    <a href="mailto:alvinrumbaoa@gmail.com">
                                            <img src="images/iphone-messages-app.png" alt="" height="80" width="80"/>
                                    </a>
                                </motion.div>
                    </div>   
